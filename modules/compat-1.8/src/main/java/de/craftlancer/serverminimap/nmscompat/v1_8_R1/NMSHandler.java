package de.craftlancer.serverminimap.nmscompat.v1_8_R1;
...
public class NMSHandler implements INMSHandler
{
    ...
    {
        net.minecraft.server.v1_8_R1.Block nmsblock = CraftMagicNumbers.getBlock(block);
        org.bukkit.craftbukkit.v1_8_R1.CraftChunk w = (org.bukkit.craftbukkit.v1_8_R1.CraftChunk) block.getChunk();
