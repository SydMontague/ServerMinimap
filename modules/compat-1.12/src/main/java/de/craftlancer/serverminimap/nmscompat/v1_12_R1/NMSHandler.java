...
public class NMSHandler implements INMSHandler
{
    ...
    {
        return colors.get(MaterialMapColor.c);
    }
    ...
    public MaterialMapColorInterface getBlockColor(Block block)
    {
        ...
        org.bukkit.craftbukkit.v1_12_R1.CraftChunk w = (org.bukkit.craftbukkit.v1_12_R1.CraftChunk) block.getChunk();
        
        BlockPosition pos = new BlockPosition(block.getX(), block.getY(), block.getZ());
        IBlockData data = w.getHandle().getBlockData(pos);
