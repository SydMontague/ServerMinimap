package de.craftlancer.serverminimap.nmscompat.v1_9_R2;
...
public class NMSHandler implements INMSHandler
{
    ...
    public MaterialMapColorInterface getBlockColor(Block block)
    {
        ...
        org.bukkit.craftbukkit.v1_9_R2.CraftChunk w = (org.bukkit.craftbukkit.v1_9_R2.CraftChunk) block.getChunk();
