...
public class NMSHandler implements INMSHandler
{
    ...
    {
        net.minecraft.server.v1_8_R2.Block nmsblock = CraftMagicNumbers.getBlock(block);
        org.bukkit.craftbukkit.v1_8_R2.CraftChunk w = (org.bukkit.craftbukkit.v1_8_R2.CraftChunk) block.getChunk();
