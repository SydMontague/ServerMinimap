package de.craftlancer.serverminimap.nmscompat.v1_13_R2;

import java.util.HashMap;

import net.minecraft.server.v1_13_R2.MaterialMapColor;
...
public class NMSHandler implements INMSHandler
{
    ...
    public MaterialMapColorInterface getBlockColor(Block block)
    {
        ...
        org.bukkit.craftbukkit.v1_13_R2.CraftChunk w = (org.bukkit.craftbukkit.v1_13_R2.CraftChunk) block.getChunk();
        ...
        MaterialMapColor nms = nmsblock.c(data, access, pos);
